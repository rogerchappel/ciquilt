...
Replace this section with the supported versions for `ciquilt`.
...
Do not imply paid support, guaranteed response times, guaranteed fixes, or service-level agreements unless `ciquilt` explicitly provides them.

## Scope

In scope:

- Vulnerabilities in ciquilt.
